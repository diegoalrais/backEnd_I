...
$animais_detalhes = [
    ...
    'gato' => [
        'nome' => 'Gato',
        'caracteristicas' => [
            ['não gosto de cachorro', 'gato/nao_gosto_de_cachorro.jpg'],
            ['tenho muito pelo', 'gato/tenho_muito_pelo.jpg']
        ]
    ], 
    'elefante' => [
        'nome' => 'Elefante',
        'caracteristicas' => [
            ['minha pele é enrugada', 'elefante/minha_pele_e_enrugada.jpg'],
            ['tenho tromba', 'elefante/tenho_tromba.png']
        ]
    ] 
];
...
while ($escolha_aleatoria === $escolha2) {
    $escolha2= rand(0,3);
}

$embaralhar= array ($escolha_aleatoria, $escolha2);     
shuffle($embaralhar);
    ...
    <body>
        ...
        <div class="container-fluid p-2 mt-3" style="background: lightgreen">
            ...
            <div class="col-md-3"></div>
                <div class="col-md-3">
                    <a href="votar.php?&apresentado=<?=$animais[$escolha_aleatoria]?>&escolhido=<?=$animais[$embaralhar[0]]?>">
                        <img width="256" src="./imagens/<?=$animais[$embaralhar[0]]?>.png" class="img-fluid" alt="Imagem de animal" />
                    </a>
                </div>
                <div class="col-md-3">
                    <a href="votar.php?&apresentado=<?=$animais[$escolha_aleatoria]?>&escolhido=<?=$animais[$embaralhar[1]]?>">
                        <img width="256" src="./imagens/<?=$animais[$embaralhar[1]]?>.png" class="img-fluid" alt="Imagem de animal" />
                    </a>
                </div>
        </div>
